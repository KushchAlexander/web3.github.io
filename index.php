...
<body>
    <div class="tg">
        <div class="wrap lh-lg">
            <form action="registracia.php"  method="POST" id="form" class="row g-3 needs-validation" validate>
                <h3 id="form">Форма</h3>
    ...
    <ul class="list-unstyled-sm">
            ...
            <li>Все таблицы</li>
            <img src="Все таблицы.PNG" alt="sign" style="width: 480px;height: 200px;">
